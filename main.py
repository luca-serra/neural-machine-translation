# -*- coding: utf-8 -*-
"""
Created on Fri Nov  1 11:08:56 2019
...
def to_pairs(doc):
	...
	pairs = [line.split('\t') for line in  lines] # list of three-element lists (the third one is not interesting (ex: "CC-BY 2.0 (France) Attribution: tatoeba.org #2877272 (CM) & #1158250 (Wittydev)"))
	return pairs
...
# save
save_clean_data(dataset, 'english-french-both.pkl') # containing train + test datasets to define the parameters of the problem
